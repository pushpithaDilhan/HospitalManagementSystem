...
public class AddRecordsGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/records.png"))); // NOI18N

        addtBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/add1.png"))); // NOI18N
    ...
    private void addtBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addtBtnMouseExited
        if(evt.getSource()== addtBtn){
            addtBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/add2.png")));
        }
    ...
    private void addtBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addtBtnMouseEntered
        if(evt.getSource()== addtBtn){
            addtBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/add1.png")));
        }
