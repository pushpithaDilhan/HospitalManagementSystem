...
public class AddDoctorGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        addBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/add1.png"))); // NOI18N
    ...
    private void addBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addBtnMouseEntered
        if(evt.getSource()== addBtn){
            addBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/add2.png")));
        }
    }//GEN-LAST:event_addBtnMouseEntered

    private void addBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addBtnMouseExited
        if(evt.getSource()== addBtn){
            addBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/add1.png")));
        }
