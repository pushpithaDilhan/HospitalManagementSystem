...
public class DoctorInterface extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        addRecBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/Add Records1.png"))); // NOI18N
        addRecBtn.setPreferredSize(new java.awt.Dimension(150, 40));
        addRecBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                addRecBtnMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                addRecBtnMouseExited(evt);
            }
        });
        ...
        appoinBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/appointment1.png"))); // NOI18N
        appoinBtn.setPreferredSize(new java.awt.Dimension(150, 40));
        appoinBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                appoinBtnMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                appoinBtnMouseExited(evt);
            }
        });
        ...
        pastReBtn.setPreferredSize(new java.awt.Dimension(150, 50));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(appoinBtn, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(addRecBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void appoinBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_appoinBtnMouseEntered
        if(evt.getSource()== appoinBtn){
            appoinBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/appointment2.png")));
        }
    }//GEN-LAST:event_appoinBtnMouseEntered

    private void appoinBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_appoinBtnMouseExited
        if(evt.getSource()== appoinBtn){
            appoinBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/appointment1.png")));
        }
    }//GEN-LAST:event_appoinBtnMouseExited

    private void addRecBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addRecBtnMouseEntered
        if(evt.getSource()== addRecBtn){
            addRecBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/Add Records2.png")));
        }
    }//GEN-LAST:event_addRecBtnMouseEntered

    private void addRecBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addRecBtnMouseExited
        if(evt.getSource()== addRecBtn){
            addRecBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/Add Records1.png")));
        }
    }//GEN-LAST:event_addRecBtnMouseExited
