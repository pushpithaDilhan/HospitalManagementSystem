...
public class HRStaffInterface extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        addDocBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/addDoc1.png"))); // NOI18N
        ...
        addEmployeeBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/addEmp1.png"))); // NOI18N
        ...
        DocAttenBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/atten1.png"))); // NOI18N
        DocAttenBtn.setBorder(null);
        DocAttenBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                DocAttenBtnMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                DocAttenBtnMouseExited(evt);
            }
        });
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(DocAttenBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                .addGap(48, 48, 48))
        );
    ...
    private void addEmployeeBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addEmployeeBtnMouseExited
        if(evt.getSource()== addEmployeeBtn){
            addEmployeeBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/addEmp1.png")));
        }
    ...
    private void addEmployeeBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addEmployeeBtnMouseEntered
        if(evt.getSource()== addEmployeeBtn){
            addEmployeeBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/addEmp2.png")));
        }
    ...
    private void addDocBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addDocBtnMouseExited
        if(evt.getSource()== addDocBtn){
            addDocBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/addDoc1.png")));
        }
    ...
    private void addDocBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addDocBtnMouseEntered
        if(evt.getSource()== addDocBtn){
            addDocBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/addDoc2.png")));
        }
    ...
    private void DocAttenBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DocAttenBtnMouseEntered
        if(evt.getSource()== DocAttenBtn){
            DocAttenBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/atten2.png")));
        }
    }//GEN-LAST:event_DocAttenBtnMouseEntered

    private void DocAttenBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DocAttenBtnMouseExited
        if(evt.getSource()== DocAttenBtn){
            DocAttenBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/atten1.png")));
        }
    }//GEN-LAST:event_DocAttenBtnMouseExited
